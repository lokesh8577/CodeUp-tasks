// This files provides some of string operations like - append, replace character, sort, reverse, palindrome check, count words, splice, split, shift and maximum repeated character in a string.
...
public:
    ...
    /* Replace a character with another in a string
       Example: Input: "hello", replace 'l' with 'x'
                Output: "hexxo"
     */
    ...
    cout << "\nMenu:" << endl;
        ...
        switch (optionSelector) {
            ...
            case 6: {
                ...
                cout << "Enter string: ";
                getline(cin, input);
                cout << "Modified String: " << obj.ReplaceChar(input) << endl;
                break;
            }
